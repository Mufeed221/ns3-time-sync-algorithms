...
INPUT="$SCRIPT_DIR/plot6.csv"
OUTPUT="$NS3_DIR/results/plot6_stats(Jitter).csv"

echo "Jitter,T1_LW_Avg,T1_LW_Std,T1_LT_Avg,T1_LT_Std,T1_DC_Avg,T1_DC_Std,T2_LW_Avg,T2_LW_Std,T2_LT_Avg,T2_LT_Std,T2_DC_Avg,T2_DC_Std" > "$OUTPUT"
awk -F, 'NR > 2 && NF >= 8 {
